...
import type { SanajahtiStats } from '../../../storage/sanajahtiStats'

export interface SanajahtiStatsModalProps {
  stats: SanajahtiStats
  onClose: () => void
}

export function SanajahtiStatsModal({ stats, onClose }: SanajahtiStatsModalProps) {
  const { t } = useI18n()
  ...
  const rows: [string, number][] = [
    ...
    [t('stats.highScore'), stats.highScore],
  ]
