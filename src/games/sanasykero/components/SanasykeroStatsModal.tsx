...
import type { SanasykeroStats } from '../../../storage/sanasykeroStats'

export interface SanasykeroStatsModalProps {
  stats: SanasykeroStats
  onClose: () => void
}

export function SanasykeroStatsModal({ stats, onClose }: SanasykeroStatsModalProps) {
  const { t } = useI18n()
