...
import type { SanapiiloStats } from '../../../storage/sanapiiloStats'

export interface SanapiiloStatsModalProps {
  stats: SanapiiloStats
  onClose: () => void
}

export function SanapiiloStatsModal({ stats, onClose }: SanapiiloStatsModalProps) {
  const { t } = useI18n()
